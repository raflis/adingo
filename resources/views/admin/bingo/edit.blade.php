        ...
        <div class="row layout-body">
            <div class="col-sm-12">
                <div class="card shadow">
                    ...
                    {!! Form::model($bingo, ['route' => ['bingo.update', $bingo->id], 'method' => 'PUT']) !!}
                    <div class="card-body row">
                        <div class="col-sm-12">
                            @include('admin.includes.alert')
                        </div>
                        @include('admin.bingo.partials.form')
                    </div>
                </div>
            </div>
            <div class="col-sm-12 my-4">
                ...
                <a class="btn btn-danger py-2 px-3" href="{{ route('bingo.index') }}">Atrás</a>
                {!! Form::close() !!}
            </div>
        </div>
